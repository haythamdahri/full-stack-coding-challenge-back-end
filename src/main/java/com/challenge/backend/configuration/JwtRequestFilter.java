 ...
 * Component class thaht extends OncePerRequestFilter for requests filtering
 */
@Component
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    /**
     * Inject instance of available JwtTokenUtil in the Servlet Container
     */
    @Autowired
    private JwtTokenUtil jwtTokenUtil;

    /**
     * Method to filter request by checking and validating (if resource is protected) jwt token before forwarding request
     */
    @Override
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
            throws ServletException, IOException {
        final String requestTokenHeader = request.getHeader("Authorization");
        // Print authorization logging for checking
